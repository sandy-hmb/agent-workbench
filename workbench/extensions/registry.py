...
from workbench.extensions.model import CAPABILITIES, ExtensionError, ExtensionManifest, load_manifest
from workbench.workspace.model import reject_sensitive_fields
from workbench.workspace.paths import extensions_root, state_root
