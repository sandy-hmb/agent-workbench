...
from workbench.extensions.capabilities import CORE_CAPABILITIES, REMOVED_CAPABILITIES
from workbench.workspace.model import WorkspaceError, parse_json_bytes
...
def normalize_extensions_lock(value: object) -> dict[str, object]:
    ...
    from workbench.extensions.registry import normalize_workspace_extensions
