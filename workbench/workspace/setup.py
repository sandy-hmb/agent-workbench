...
from workbench.workspace.input import WorkspaceInput, load_workspace_input  # noqa: E402
from workbench.workspace.local import (  # noqa: E402
    LocalSettings,
...
def _prepare_outputs(
    ...
    if operation == "init":
        ...
        template = KIT_ROOT / "templates" / "workspace" / "AGENTS.md"
...
def _preview_state(
    ...
    directories = (items_root(root), extensions_root(root), cache_root(root))
