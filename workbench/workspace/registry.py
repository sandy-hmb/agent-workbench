...
from workbench.extensions.providers import bound_provider_ref, run_bound_provider  # noqa: E402
    ...
    try:
        ...
        if args.command == "branch":
            ...
            if args.provider_input is not None:
                from workbench.workspace.model import read_json
            ...
            if bound_provider_ref(workspace, "branch.naming", repository) is not None:
                ...
                from workbench.workspace.model import _git_branch_valid
